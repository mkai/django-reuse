# # from: https://raw.github.com/wimleers/fileconveyor/14229e762691fba98280adaf029590d3dbf2f3a4/code/dependencies/storages/SFTPStorage.py
...
class HTTPSFTPStorage(SFTPStorage):
    ...
    def _mkdir(self, path):
        ...
        if not self.exists(parent):
            raise IOError('Cannot create directory tree %s' % path)
            # self._mkdir(parent)
